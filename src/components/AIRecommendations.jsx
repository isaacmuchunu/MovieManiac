    ...
    <div className="bg-gradient-to-br from-gray-900 via-netflix-red/10 to-gray-900 rounded-2xl p-6 md:p-8 border border-gray-800">
      ...
      {!selectedMood ? (
        ...
        <>
          ...
          {/* AI Insight */}
          <div className="mt-6 bg-netflix-red/10 border border-netflix-red/20 rounded-lg p-4">
            <div className="flex items-start gap-3">
              <div className="w-8 h-8 bg-netflix-red/20 rounded-lg flex items-center justify-center flex-shrink-0">
                <svg className="w-5 h-5 text-netflix-red" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
              </div>
              <div>
                <h4 className="text-red-300 font-medium text-sm">AI Insight</h4>
      ...
      {!isAuthenticated && (
        <div className="mt-6 text-center">
          <p className="text-gray-500 text-sm">
            <Link to="/login" className="text-netflix-red hover:text-red-400">Sign in</Link>
